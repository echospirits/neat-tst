...
- User-visible: Yes.
- Production readiness: Not reviewed for production. The additive TST migration applied successfully on 2026-09-23. Local production build and `tsc --noEmit` passed. Live desktop verification confirmed the Day and Week tabs, the seven-day grid and unscheduled tray, and no horizontal overflow at 1536 x 695. The required 390 x 844 mobile viewport was not available in the browser controls used for this pass.
