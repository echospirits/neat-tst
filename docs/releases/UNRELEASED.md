...
- Environment/config: None.
- User-visible: Yes.
- Production readiness: Not reviewed for production; 48 focused tests, typecheck, and production build passed. Policy code deployment `6jqd6ukwHnar4xnmycKCLYsPDerf` for `ddfbc83e` reached Ready on TST. Desktop Day and Week layouts and date-less time disabling were reviewed live; the prior 1440 x 900 and 390 x 844 baseline review is recorded in the scheduler checkpoint.
